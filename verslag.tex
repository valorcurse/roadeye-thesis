...
\titelblad                   %argumenten invullen
  {Een \LaTeX\ `model' voor het afstudeerverslag} %hier titel invullen 
  {Onbekend Talent (123456)} %hier naam en (stamnummer) van student invullen
  {\TI}                      %hier opleiding \TI, \INF of \BI invullen
  {\today}                   %{\today} concept of {1 april 2011} definitief
  {Dhr. M. de Uil}           %eerste docent
  {}                         %tweede docent
