...
\paragraaf{Market Research}

A market research will also be done, with the purpose of finding a scenario or niche in the market where this application can be used. The results of this research are shown later in this thesis because the results are then compared to the specifications of this application found and explained throughout this thesis. See chapter Market Research.
...
This research was done with the goal of finding similar products, both consumer and government, which are used for the same of similar purposes and discovering, if possible, what they can and cannot do. This information can then be used for finding a scenario or niche in the market where this project can solve a problem for which there is no available product. 
...
Some research was also done over existing Android applications \cite{eli-recognition} \cite{license-plate-reader} \cite{tmg-plate-reader} \cite{viewforce-alpr} on the Play Store which might have the similar functionality. Few applications did license plate recognition and the ones that did did not work.
